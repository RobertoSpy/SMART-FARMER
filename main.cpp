...
class centrareaButtons
{
public:
    Button Player1Button, Player1vsPlayer2Button, SettingsButton, AboutButton,
        BackPlayer1Button, ChapterButton, SoloButton, BackPlayer1vsPlayer2Button,
        StartAgainButton, BackSettingsButton, BackAboutButton, BackChapterButton, BackSoloButton;
    Button Level1Button, Level2Button, Level3Button, Level4Button, Level5Button, BackOutputButton;
...
public:
    Shape(float cellSize) : cellSize(cellSize) {}

    virtual void draw(sf::RenderWindow& window, float x, float y) const = 0;
...
public:
    ...
    void draw(sf::RenderWindow& window, float x, float y) const override {
        // Desenează forma pentru Piesa5 (trapez)
...
private:
    ...
    void saveLevelToFile(const std::string& levelFileName);
...
public:
        ...
        currentReview("")
    {
        ...
        cout << " Game a fost creat!\n";

        if (!font.loadFromFile("res/fonts/Inkfree.ttf"))
        {
            cerr << "EROARE LA INCARCAREA FONTULUI!\n";
        ...
        volumeDivider.setPosition(volumeBar.getPosition().x + volumeBar.getSize().x / 2 - volumeDivider.getSize().x / 2, volumeBar.getPosition().y); 
...
{
    const CurrentLevelType& matrix = currentLevel;
    ...
    while (file >> x >> y) {
        ...
        if (ok == 1) {
            if (!isFileOpened) {
                ...
                isFileOpened = outputFile.is_open();
            }
...
void Game::updateMatrix()
{
    ...
    case 1:
        ...
        currentLevel.setPiesaType(1, 1, ShapeType::Piesa1);  saveLevelToFile("level1"); v[1][1] = 1;
        currentLevel.setPiesaType(3, 1, ShapeType::Piesa1);  saveLevelToFile("level1"); v[3][1] = 1; 
        currentLevel.setPiesaType(3, 3, ShapeType::Piesa4);  saveLevelToFile("level1"); v[3][3] = 4;
        currentLevel.setPiesaType(1, 7, ShapeType::Piesa4);  saveLevelToFile("level1");   v[1][7] = 4;           
        currentLevel.setPiesaType(3, 7, ShapeType::Piesa5);  saveLevelToFile("level1");   v[3][7] = 5;          
        currentLevel.setPiesaType(5, 7, ShapeType::Piesa5);  saveLevelToFile("level1");   v[5][7] = 5;
        currentLevel.setPiesaType(5, 1, ShapeType::Piesa2);  saveLevelToFile("level1");   v[5][1] = 2;                
        currentLevel.setPiesaType(5, 3, ShapeType::Piesa2);  saveLevelToFile("level1");    v[5][3] = 2;
    ...
    case 2:
        ...
        currentLevel.setPiesaType(1, 5, ShapeType::Piesa1);  v[1][5] = 1;           saveLevelToFile("level2");
        currentLevel.setPiesaType(1, 7, ShapeType::Piesa1);  v[1][7] = 1;           saveLevelToFile("level2"); 
        currentLevel.setPiesaType(3, 1, ShapeType::Piesa4);   v[3][1] = 4;          saveLevelToFile("level2");
        currentLevel.setPiesaType(5, 1, ShapeType::Piesa4);   v[5][1] = 4;          saveLevelToFile("level2");
        currentLevel.setPiesaType(1, 1, ShapeType::Piesa5);   v[1][1] = 5;          saveLevelToFile("level2");
        currentLevel.setPiesaType(1, 3, ShapeType::Piesa5);   v[1][3] = 5;          saveLevelToFile("level2");
        currentLevel.setPiesaType(3, 7, ShapeType::Piesa2);    v[3][7] = 2;         saveLevelToFile("level2");
        currentLevel.setPiesaType(5, 7, ShapeType::Piesa2);    v[5][7] = 2;         saveLevelToFile("level2");
    ...
    case 3:
        currentLevel.setPiesaType(1, 1, ShapeType::Piesa3); v[1][1] = 65;  saveLevelToFile("level3");  
        currentLevel.setPiesaType(1, 3, ShapeType::Piesa3);   v[1][3] = 65; saveLevelToFile("level3");
        currentLevel.setPiesaType(3, 5, ShapeType::Piesa4); v[3][5] = 4;  saveLevelToFile("level3");
        currentLevel.setPiesaType(3, 7, ShapeType::Piesa1); v[3][7] = 1;  saveLevelToFile("level3");
    ...
    case 4:
        currentLevel.setPiesaType(1, 1, ShapeType::Piesa3); v[1][1] = 65; saveLevelToFile("level4"); 
        currentLevel.setPiesaType(1, 5, ShapeType::Piesa3); v[1][5] = 65;  saveLevelToFile("level4");
        currentLevel.setPiesaType(1, 7, ShapeType::Piesa3); v[1][7] = 65; saveLevelToFile("level4");
        currentLevel.setPiesaType(5, 1, ShapeType::Piesa4); v[5][1] = 4; saveLevelToFile("level4");
        currentLevel.setPiesaType(1, 3, ShapeType::Piesa5);  v[1][3] = 5; saveLevelToFile("level4");
        currentLevel.setPiesaType(5, 3, ShapeType::Piesa1); v[5][3] = 1; saveLevelToFile("level4");
    ...
    case 5:
        currentLevel.setPiesaType(1, 7, ShapeType::Piesa3); v[1][7] = 65; saveLevelToFile("level5");
        currentLevel.setPiesaType(5, 3, ShapeType::Piesa3); v[5][3] = 65; saveLevelToFile("level5");
        currentLevel.setPiesaType(5, 5, ShapeType::Piesa3); v[5][5] = 65; saveLevelToFile("level5");
        currentLevel.setPiesaType(1, 3, ShapeType::Piesa4); v[1][3] = 4; saveLevelToFile("level5");
        currentLevel.setPiesaType(3, 3, ShapeType::Piesa2);  v[3][3] = 2; saveLevelToFile("level5");
        currentLevel.setPiesaType(5, 7, ShapeType::Piesa1); v[5][7] = 1; saveLevelToFile("level5");
...
void openVisualStudioSolution(const std::string& solutionPath) {
    std::string command = "start devenv " + solutionPath;
    int result = system(command.c_str());

    if (result == 0) {
        std::cout << "Visual Studio a fost lansat cu succes." << std::endl;
    }
    else {
        std::cerr << "Eroare la lansarea Visual Studio." << std::endl;
    }
}
        ...
        while (game.window.pollEvent(event))
        {
            ...
            if (event.type == sf::Event::MouseButtonPressed && event.mouseButton.button == sf::Mouse::Left)
            {
                ...
                if (game.buttons.Player1Button.shape.getGlobalBounds().contains(mousePos.x, mousePos.y) && game.currentState == GameState::MainMenu)
                {
                    ...
                    cout << "Ai apasat butonul Player1!\n";
                }
                else  if (game.buttons.Player1vsPlayer2Button.shape.getGlobalBounds().contains(mousePos.x, mousePos.y) && game.currentState == GameState::MainMenu)
                {
                    ...
                    cout << "Ai apasat butonul Player1vsPLayer2!\n";
                ...
                else  if (game.buttons.SettingsButton.shape.getGlobalBounds().contains(mousePos.x, mousePos.y) && game.currentState == GameState::MainMenu)
                {
                    ...
                    cout << "Ai apasat butonul Settings!\n";
                }
                else if (game.buttons.SoloButton.shape.getGlobalBounds().contains(mousePos.x, mousePos.y) && game.currentState == GameState::Player1)
                {
                    ...
                    std::cout << "Ai apasat butonul Solo!\n";


                    string mergebineSolutionPath = "C:\\Users\\Roberto\\OneDrive\\Desktop\\Smart Farmer\\Test project\\mergebine\\mergebine.sln.cpp";
                ...
                else if (game.buttons.ChapterButton.shape.getGlobalBounds().contains(mousePos.x, mousePos.y) && game.currentState == GameState::Player1)
                {
                    ...
                    cout << "Ai apasat butonul Chapter!\n";
                }
                ...
                if (game.currentState == GameState::Chapter) {
                    if (game.buttons.Level1Button.shape.getGlobalBounds().contains(mousePos.x, mousePos.y))
                    {
                        ...
                        cout << "Ai apasat butonul Level 1!\n";
                    ...
                    else if (game.buttons.Level4Button.shape.getGlobalBounds().contains(mousePos.x, mousePos.y))
                    {
                        ...
                        cout << "Ai apasat butonul Level 4!\n";
                    ...
                    else if (game.buttons.Level5Button.shape.getGlobalBounds().contains(mousePos.x, mousePos.y))
                    {
                        ...
                        cout << "Ai apasat butonul Level 5!\n";
